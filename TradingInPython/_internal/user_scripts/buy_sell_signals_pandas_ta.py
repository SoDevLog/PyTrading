...
Adapted from: Bruno
Blog: https://www.trading-et-data-analyses.com/p/strategies-dans-tradinginpython.html
...
stocksymbols = ['TATACOMM.NS']
startdate = date(2025,1,1)
end_date = date.today()
print(end_date)
def getMyPortfolio(stocks = stocksymbols ,start = startdate , end = end_date):
    data = yfinance.download( 
        stocks, start=startdate, end=end_date, prepost=True, auto_adjust=False
    )
    return data
...
# Remplir les valeurs manquantes après calcul des indicateurs
